...
print_help() {
    ...
    echo "  -x|--input-xmls     Input directory with xml files. (optional)"
    echo "  -e|--example        Example outputs for comparison. (optional)"
    echo "  -u|--test-utility   Path to test utility. (optional)"
    echo "  -t|--test-output    Test utility output folder. (optional)"
